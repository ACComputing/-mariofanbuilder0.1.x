...
pygame.init()
pygame.display.set_caption("AC'S MFB 0.1")
...
class Editor:
    ...
    def cmd_exit(self):
        res = MessageBox(self.screen,"Exit","Exit AC'S MFB 0.1?",("Yes","No")).run()
        if res=="Yes":
            pygame.quit()
            sys.exit()
...
def main_menu(screen):
    ...
    while True:
        ...
        draw_text(screen, "AC'S MFB 0.1", (tr.x+4, tr.y+4), WHITE, FONT_SMALL)
        ...
        draw_text(screen, "AC'S MFB 0.1", (cr.centerx, cr.y+40), SYS_HIGHLIGHT, FONT_TITLE, True)
        draw_text(screen, "Level Editor", (cr.centerx, cr.y+70), SYS_TEXT, FONT, True)
        draw_text(screen, "AC Holding", (cr.centerx, cr.y+92), GRAY, FONT_SMALL, True)
