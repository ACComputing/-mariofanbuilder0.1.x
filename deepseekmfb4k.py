...
pygame.init()
pygame.display.set_caption("Mario Fan Builder - SMBX Style")
...
def main_menu(screen):
    ...
    while True:
        ...
        draw_text(screen, "Mario Fan Builder - SMBX Style", (tr.x+4, tr.y+4), WHITE, FONT_SMALL)
